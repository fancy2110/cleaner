    ...
    <div class="folder-scanner">
        <div class="scanner-header">
            ...
            <div class="scanner-controls">
                <input v-model="scanPath" type="text" placeholder="输入要扫描的路径，如 /Users 或 C:\" class="path-input"
                    :disabled="isScanning" />
                <button @click="startScan" :disabled="!scanPath || isScanning" class="btn btn-primary">
                ...
                <button @click="clearData" :disabled="isScanning" class="btn btn-secondary">
                    清除数据
                </button>
            </div>
        </div>
...
import { ScannerService, ScanProgress } from '@/services/ScannerService';
